...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lihairui/LHRAlerViewDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lihairui' => 'hairui.li@meiduimall.com' }
  s.source           = { :git => 'https://github.com/lihairui/LHRAlerViewDemo.git', :tag => s.version.to_s }
